...
<div class="content clearfix">
	<a href="${rootpath}master/add/role.html" class="btn btn-primary pull-right">Add</a>
</div>
			...
			<c:forEach items="${dataList}" var="item" varStatus="status">
					<tr id="tr${item.id}">
						...
						<ul style="list-style: none;">
							<li><a href="${rootpath}master/view/role/${item.id}.html" title="view"><i class="icon-check"></i></a></li>
							<li><a href="${rootpath}master/update/role/${item.id}.html" title="edit"><i class="icon-edit"></i></a></li>
							<li><a href="${rootpath}master/delete/role/${item.id}.html" title="remove" class="delete"><i class="icon-remove"></i></a></li>
						</ul>					
						</td>
					</tr>
			</c:forEach>
