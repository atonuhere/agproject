...
<footer class="footer">
        ...
        <div class="copyrights">
            <div class="container">
                <div class="col-lg-6 col-md-6 col-sm-12 columns">
                    <p>Copyright © 2014 - All right reserved. Designed by <a title="Enterprise HTML5 Theme" href="http://gfsindia.com/">Greenfield Solutions</a></p>
                </div><!-- end widget -->
    ...
    <script>
		$(document).ready(function() {
			$("#popularitems, #popularposts").owlCarousel({
			items : 3,
			lazyLoad : true,
			navigation : false
			});
