		...
		<div class="general-title">
			...
			<div class="portfolio-wrapper">
                <div id="owl-demo" class="owl-carousel">
                   ...
                   <div class="item">
                    	<a data-rel="prettyPhoto" href="demos/06_portfolio.png">
                        	<img class="lazyOwl" src="demos/06_portfolio.png" data-src="demos/06_portfolio.png" alt="">
                        	<div>
                                <small>Identity Card</small>
                                <span>Psd Identity Card Presentation</span>
					...
					<div class="item">
                    	<a data-rel="prettyPhoto" href="http://www.youtube.com/watch?v=pknp4J0zzpc">
                        	<img class="lazyOwl" src="demos/05_portfolio.png" data-src="demos/05_portfolio.png" alt="">
                        	<div>
                                <small>Mockup Templates</small>
                                <span>Stationery Branding Mock Up</span>
                    ...
                    <div class="item">
                    	<a href="single-portfolio-1.html">
                        	<img class="lazyOwl" src="demos/07_portfolio.png" data-src="demos/07_portfolio.png" alt="">
                        	<div>
                                <small>Print Ready</small>
                                <span>Web Screens Perspective Mock Up</span>
                    ...
                    <div class="item">
                    	<a href="single-portfolio-1.html">
                        	<img class="lazyOwl" src="demos/08_portfolio.png" data-src="demos/08_portfolio.png" alt="">
                        	<div>
                                <small>Mockup Templates</small>
                                <span>Doma Tri Fold Brochure Template</span>
                                <i class="fa fa-link"></i>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item">
                    	<a data-rel="prettyPhoto" href="demos/01_portfolio.png">
                        	<img class="lazyOwl" src="demos/01_portfolio.png" data-src="demos/01_portfolio.png" alt="">
                        	<div>
                                <small>Mockup Templates</small>
                                <span>Funky Graphics</span>
                                <i class="fa fa-search"></i>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item">
                    	<a data-rel="prettyPhoto" href="demos/02_portfolio.png">
                        	<img class="lazyOwl" src="demos/02_portfolio.png" data-src="demos/02_portfolio.png" alt="">
                        	<div>
                                <small>E-Brochure</small>
                                <span>BIBAs 2013 Brochure</span>
                                <i class="fa fa-search"></i>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item">
                    	<a data-rel="prettyPhoto" href="demos/03_portfolio.png">
                        	<img class="lazyOwl" src="demos/03_portfolio.png" data-src="demos/03_portfolio.png" alt="">
                        	<div>
                                <small>Print Ready</small>
                                <span>Magazine Cover Layouts</span>
                                <i class="fa fa-search"></i>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="item">
                    	<a data-rel="prettyPhoto" href="demos/04_portfolio.png">
                        	<img class="lazyOwl" src="demos/04_portfolio.png" data-src="demos/04_portfolio.png" alt="">
                        	<div>
                                <small>Mockup Templates</small>
                                <span>Clean Audio Pro</span>
                                <i class="fa fa-search"></i>
                            </div>
                        </a>
                    </div>
    ...
    <section class="section2">
    	<div class="container">
        	<div class="message text-center">
                    <h2 class="big-title">Thanks for using <span>genuine</span> website template!</h2>
                    ...
                    <a class="button large" href="#">LEARN MORE ABOUT</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class=" dmbutton large" href="#">CONTACT US TODAY</a>
            </div><!-- end message -->
    	</div><!-- end container -->
	...
	<section class="section1">
    	<div class="container">
        	...
        	<div class="col-lg-6 col-md-6 col-sm-12">
                <div class="widget" data-effect="slide-left">
                <h3 class="title">Top Reasons to Buy Genuine</h3>
                    <div class="accordion" id="accordion2">
                      <div class="accordion-group">
                        <div class="accordion-heading">
                          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseOne">
                            <em class="icon-minus icon-fixed-width"></em>Responsive layout design
                          </a>
                        </div>
                      ...
                      <div class="accordion-group">
                        <div class="accordion-heading">
                          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseTwo">
                            <em class="icon-plus icon-fixed-width"></em>High-resolution graphics
                          </a>
                        </div>
                      ...
                      <div class="accordion-group">
                        <div class="accordion-heading">
                          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseThree">
                            <em class="icon-plus icon-fixed-width"></em>Unlimited color schemes
                          </a>
                        </div>
                      ...
                      <div class="accordion-group">
                        <div class="accordion-heading">
                          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFour">
                            <em class="icon-plus icon-fixed-width"></em>Revolution slideshow plugin
                          </a>
                        </div>
                          ...
                          <div class="accordion-group">
                            <div class="accordion-heading">
                              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#collapseFive">
                                <em class="icon-plus icon-fixed-width"></em>10+ custom homepage styles
                              </a>
                            </div>
        	...
        	<div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <h3 class="title">Why Choose us?</h3>
					<ul class="check">
						<li><a href="#">10+ homepage style (check features menu)</a></li>
                ...
                <h3 class="title">About Our Company</h3>
                   <div class="tabbable">
                      <ul class="nav nav-tabs">
                        ...
                        <li><a href="#contact" data-toggle="tab">Map</a></li>
                        <li><a href="#details" data-toggle="tab">Contact</a></li>
                      </ul>
