...
import com.gfs.erm.model.service.EventService;
import com.gfs.erm.model.service.EventServiceImpl;
...
public class LogUtil {
    ...
    private static EventService ebus = new EventServiceImpl();
	...
	private static void insertLogIntoDataBase(int type, String summary, String content, String username, Throwable e){
	    if (type==LOG_ERROR || type==LOG_FATAL || type==LOG_INFO) {
	        ...
	        try {
	           ...
	           UserTO uto = udel.getUser(username);
